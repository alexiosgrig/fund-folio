...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/IXdiIZ59iF)
...
```sh
npx nx serve fund-folio
```

To create a production bundle:

```sh
npx nx build fund-folio
```

To see all available targets to run for a project, run:

```sh
npx nx show project fund-folio
```
